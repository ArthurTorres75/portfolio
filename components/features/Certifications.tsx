...
export function Certifications(): React.JSX.Element {
  ...
  const certifications = [
    ...
    {
      title: t("cert12.title", language),
      issuer: t("cert12.issuer", language),
      date: t("cert12.date", language),
      icon: (
        <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-purple-500/20 text-purple-300 font-bold text-xs font-mono">
          UX
        </span>
      ),
      credentialUrl: "https://www.udemy.com/certificate/UC-11fd08aa-ccfb-43d4-8220-9f3e1bedbfae/",
    },
    {
    ...
    <div className="max-w-6xl mx-auto">
      ...
      >
        ...
        <EducationCard
          variant="degree"
          icon="🎓"
          title={t("education.degree.title", language)}
          issuer={t("education.degree.issuer", language)}
          date={t("education.degree.date", language)}
        />
        ...
        <EducationCard
          variant="diploma"
          icon="📜"
          title={t("education.bachelor.title", language)}
          issuer={t("education.bachelor.issuer", language)}
          date={t("education.bachelor.date", language)}
        />
      </motion.div>
